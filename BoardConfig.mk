...
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 3229614080
BOARD_SUPER_PARTITION_SIZE := $(BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE)

BOARD_SUPER_PARTITION_GROUPS := grandpplte_dynpart
BOARD_GRANDPPLTE_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_GRANDPPLTE_DYNPART_PARTITION_LIST := system product vendor odm
...
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/fstab.mt6735
